    ...
    return (
        ...
        <main>
            <article className={"product"}>
                <img
                    src="https://www.afghaanmarket.nl/wp-content/uploads/2021/09/citroen.png"
                    alt="Citroen"/>
            ...
            <article className={"product"}>
                ...
                <p className={"product-description"}>Limoen is familie van de citroen en de sinaasappel en behoort tot de citrusvruchten
            ...
            <article className={"product"}>
                ...
                <p className={"product-description"}>Een ijsblokje of ijsklontje is bevroren water in de vorm van een klein blokje. Het wordt gemaakt in
                    een diepvriezer door water in een plastic vorm te laten bevriezen.</p>
            </article>
        </main>
            </>
    );
